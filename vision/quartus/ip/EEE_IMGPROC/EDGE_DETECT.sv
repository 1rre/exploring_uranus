...
assign abs_dh[0] = $unsigned(dh[0]<0? -dh[0] : dh[0]);
assign abs_dh[1] = $unsigned(dh[1]<0? -dh[1] : dh[1]);
assign abs_dh[2] = $unsigned(dh[2]<0? -dh[2] : dh[2]);
assign abs_dv[0] = $unsigned(dv[0]<0? -dv[0] : dv[0]);
assign abs_dv[1] = $unsigned(dv[1]<0? -dv[1] : dv[1]);
assign abs_dv[2] = $unsigned(dv[2]<0? -dv[2] : dv[2]);
...
assign red = rq<0?8'b0:$unsigned(rq[7:0]);
assign blue = gq<0?8'b0:$unsigned(gq[7:0]);
assign green = bq<0?8'b0:$unsigned(bq[7:0]);
