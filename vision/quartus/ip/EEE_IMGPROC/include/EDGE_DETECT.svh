`ifndef EDGE_DETECT_SVH
`define EDGE_DETECT_SVH

`include "ip/EEE_IMGPROC/include/COLOUR_DETECT.svh"
`include "ip/EEE_IMGPROC/include/LOOKUP_COLOUR.svh"
...
assign red_t = (r_out>T_MIN)? r_out : 8'h0;
assign green_t = (g_out>T_MIN)? g_out : 8'h0;
assign blue_t = (b_out>T_MIN)? b_out : 8'h0;

wire [7:0] red_t_1, green_t_1, blue_t_1;
assign red_t_1 = (r_out_1>T_MIN)? r_out_1 : 8'h0;
assign green_t_1 = (g_out_1>T_MIN)? g_out_1 : 8'h0;
assign blue_t_1 = (b_out_1>T_MIN)? b_out_1 : 8'h0;
